          ...
          <div className="grid grid-cols-3 gap-y-6 gap-x-2">
            <AppIcon href="https://myaccount.google.com/" label="Account" icon={
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M12 4c-4.42 0-8 3.58-8 8c0 1.95.7 3.73 1.86 5.12a9.95 9.95 0 0 1 12.28 0A7.96 7.96 0 0 0 20 12c0-4.42-3.58-8-8-8m0 9c-1.93 0-3.5-1.57-3.5-3.5S10.07 6 12 6s3.5 1.57 3.5 3.5S13.93 13 12 13" opacity="0.3"></path>
...
const AppIcon: React.FC<{ href: string; label: string; icon: React.ReactNode }> = ({ href, label, icon }) => (
  ...
  >
    <div className="text-gray-300 group-hover:text-white transition-colors w-10 h-10 flex items-center justify-center">
      {icon}
    </div>
